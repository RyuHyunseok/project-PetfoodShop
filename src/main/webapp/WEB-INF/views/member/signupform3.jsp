...
<title>Insert title here</title>
	<link rel="stylesheet" href="resources/css/signupform3.css" type="text/css">
</head>
<body>
  <div id="card" class="animated fadeIn" >
    <div id="upper-side">
        ...
        <h3 id="status"><b style="color: white">회원가입이 완료 되었습니다.</b></h3>
    </div>
    <div id="lower-side">
        <p id="message">
            ${name }님의 회원가입을 축하합니다.
            <br>알차고 실속있는 서비스로 찾아뵙겠습니다.
        </p>
        <hr>
        <a href="home" class="contBtn" style="color: #7fad39">홈으로</a>
        <a href="signinform" id="edit" class="contBtn">로그인</a>
    </div>
</div>

<script src="resources/js/signupform3.js"></script>
</body>
</html>