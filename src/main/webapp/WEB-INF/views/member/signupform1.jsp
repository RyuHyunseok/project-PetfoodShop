...
<meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="resources/css/signupform1.css?after" type="text/css">
</head>
<body>
  <form action="signupform2" id="" method="post" onsubmit="return agreeCheck();">
  <div class="login-page">
    <div id="title">약관동의</div>
    <div id="blankBox"></div>
    <hr>
    <div id="blankBox"></div>
    ...
    <div class="form">
      <div class="checkBox">
        <span class="checkbox">
          ...
          <label for="checkbox1">(필수)만 14세 이상입니다</label>
        </span>
      </div>
      ...
      <div class="checkBox">
        <span class="checkbox">
          <input type="checkbox" id="checkbox2" onclick="selectAll()" />
          <label for="checkbox2" onclick="selectAll()">OGANI의 모든 약관을 확인하고 전체 동의합니다. <span id="textEdit">(전체동의, 선택항목도 포함됩니다.)</span></label>
        </span>
      </div>
      ...
      <div class="checkBox">
        <span class="checkbox">
          <input type="checkbox" id="checkbox3" value="yes" onclick="selectCancel('checkbox3')" />
          <label for="checkbox3" onclick="selectCancel('checkbox3')"><b>(필수)</b> 이용약관</label>
        </span>
        <textarea spellcheck="false" readonly="readonly">제1조(목적)

          표준약관 제10023호
          
          이 약관은 지앤건강생활 회사(전자거래 사업자)가 운영하는 듀먼(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
          ※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」
          
          
          제2조(정의)
          
          ① "몰"이란 지앤건강생활 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
          ...
          ⑤ 동일인물이 부당한 방법으로 여러 차례 가입하여 혜택을 중복으로 취하는 경우 "몰"은 회원자격을 제한 및 정지 시킬수 있으며 그 혜택 또한 지급 정지할 수 있다.
          ⑥ 동일인물이 2회 이상 가입한 경우 "몰"은 최초 아이디를 제외하고 회원 자격을 제한 및 정지 시킬 수 있다.
          ⑦ '⑤,⑥' 의 동일인물 조건은 배송 주소지, 핸드폰 번호, 주문자성명, 가입자성명으로 판단한다.
          ...
          1. 이 약관은 2021년 03월 30일부터 적용됩니다.
        </textarea>
      </div>

      <div class="checkBox">
        <span class="checkbox">
          <input type="checkbox" id="checkbox4" onclick="selectCancel('checkbox4')"/>
          <label for="checkbox4" onclick="selectCancel('checkbox4')"><b>(필수)</b> 개인정보 수집 및 이용</label>
        </span>
        <textarea spellcheck="false" readonly="readonly">
...
- 보유 및 이용기간 : 회원탈퇴 후 5일까지
    ...
    <div id="footer">
      <button type="button" onclick="signinform()">취소</button>
      <button type="submit">다음단계</button>
    </div>
  </div>
  </form>
  <form id="signinform" action="signinform"></form>
<script src="resources/js/signupform1.js"></script>
</body>
</html>